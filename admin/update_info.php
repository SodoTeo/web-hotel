...
{ 
    ...
    $stmt=$connect->prepare("UPDATE hotels SET h_title='$h_title', h_nomo='$h_nomo', h_price='$h_price', h_stars='$h_stars', h_address='$h_address', h_phone='$h_phone', h_id='$user_id', h_desc='$h_desc' WHERE h_name='$h_name'");
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <select name="h_nomo" class="form-control" required>
                                                <option value="<?php echo $row['h_nomo'] ?>"><?php echo $row['h_nomo'] ?></option>
